...
void __init trap_init(void)
{
    ...
    {
#if (defined(CONFIG_BCM93380) && defined(CONFIG_BCM_LOT1) && defined(CONFIG_BCM_T0_IDLE) && !defined(CONFIG_BCM_VECTOR)) || defined(CONFIG_BCMKILAUEA) || (defined(CONFIG_BCM93383) && !defined(CONFIG_BCM_VECTOR))

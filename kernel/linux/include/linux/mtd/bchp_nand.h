 ...
 ***************************************************************************/
#define BCHP_NAND_REVISION                       0x00000200 /* NAND Revision */
#define BCHP_NAND_CMD_START                      0x00000204 /* Nand Flash Command Start */
#define BCHP_NAND_CMD_EXT_ADDRESS                0x00000208 /* Nand Flash Command Extended Address */
#define BCHP_NAND_CMD_ADDRESS                    0x0000020c /* Nand Flash Command Address */
#define BCHP_NAND_CMD_END_ADDRESS                0x00000210 /* Nand Flash Command End Address */
#define BCHP_NAND_CS_NAND_SELECT                 0x00000214 /* Nand Flash EBI CS Select */
#define BCHP_NAND_CS_NAND_XOR                    0x00000218 /* Nand Flash EBI CS Address XOR with 1FC0 Control */
#define BCHP_NAND_SPARE_AREA_READ_OFS_0          0x00000220 /* Nand Flash Spare Area Read Bytes 0-3 */
#define BCHP_NAND_SPARE_AREA_READ_OFS_4          0x00000224 /* Nand Flash Spare Area Read Bytes 4-7 */
#define BCHP_NAND_SPARE_AREA_READ_OFS_8          0x00000228 /* Nand Flash Spare Area Read Bytes 8-11 */
#define BCHP_NAND_SPARE_AREA_READ_OFS_C          0x0000022c /* Nand Flash Spare Area Read Bytes 12-15 */
#define BCHP_NAND_SPARE_AREA_WRITE_OFS_0         0x00000230 /* Nand Flash Spare Area Write Bytes 0-3 */
#define BCHP_NAND_SPARE_AREA_WRITE_OFS_4         0x00000234 /* Nand Flash Spare Area Write Bytes 4-7 */
#define BCHP_NAND_SPARE_AREA_WRITE_OFS_8         0x00000238 /* Nand Flash Spare Area Write Bytes 8-11 */
#define BCHP_NAND_SPARE_AREA_WRITE_OFS_C         0x0000023c /* Nand Flash Spare Area Write Bytes 12-15 */
#define BCHP_NAND_ACC_CONTROL                    0x00000240 /* Nand Flash Access Control */
#define BCHP_NAND_CONFIG                         0x00000244 /* Nand Flash Config */
#define BCHP_NAND_TIMING_1                       0x00000248 /* Nand Flash Timing Parameters 1 */
#define BCHP_NAND_TIMING_2                       0x0000024c /* Nand Flash Timing Parameters 2 */
#define BCHP_NAND_SEMAPHORE                      0x00000250 /* Semaphore */
#define BCHP_NAND_FLASH_DEVICE_ID                0x00000254 /* Nand Flash Device ID */
#define BCHP_NAND_BLOCK_LOCK_STATUS              0x00000258 /* Nand Flash Block Lock Status */
#define BCHP_NAND_INTFC_STATUS                   0x0000025c /* Nand Flash Interface Status */
#define BCHP_NAND_ECC_CORR_EXT_ADDR              0x00000260 /* ECC Correctable Error Extended Address */
#define BCHP_NAND_ECC_CORR_ADDR                  0x00000264 /* ECC Correctable Error Address */
#define BCHP_NAND_ECC_UNC_EXT_ADDR               0x00000268 /* ECC Uncorrectable Error Extended Address */
#define BCHP_NAND_ECC_UNC_ADDR                   0x0000026c /* ECC Uncorrectable Error Address */
#define BCHP_NAND_FLASH_READ_EXT_ADDR            0x00000270 /* Flash Read Data Extended Address */
#define BCHP_NAND_FLASH_READ_ADDR                0x00000274 /* Flash Read Data Address */
#define BCHP_NAND_PROGRAM_PAGE_EXT_ADDR          0x00000278 /* Page Program Extended Address */
#define BCHP_NAND_PROGRAM_PAGE_ADDR              0x0000027c /* Page Program Address */
#define BCHP_NAND_COPY_BACK_EXT_ADDR             0x00000280 /* Copy Back Extended Address */
#define BCHP_NAND_COPY_BACK_ADDR                 0x00000284 /* Copy Back Address */
#define BCHP_NAND_BLOCK_ERASE_EXT_ADDR           0x00000288 /* Block Erase Extended Address */
#define BCHP_NAND_BLOCK_ERASE_ADDR               0x0000028c /* Block Erase Address */
#define BCHP_NAND_INV_READ_EXT_ADDR              0x00000290 /* Flash Invalid Data Extended Address */
#define BCHP_NAND_INV_READ_ADDR                  0x00000294 /* Flash Invalid Data Address */
#define BCHP_NAND_BLK_WR_PROTECT                 0x00000298 /* Block Write Protect Enable and Size for EBI_CS0b */
 ...
 ***************************************************************************/
#if defined(CONFIG_BCM96368) || defined(CONFIG_BCM96362) || defined(CONFIG_BCM96816)
#define BCHP_NAND_FLASH_CACHEi_ARRAY_BASE                          0x00000600
#elif defined(CONFIG_BCM96328)
#define BCHP_NAND_FLASH_CACHEi_ARRAY_BASE                          0x00000400
#endif

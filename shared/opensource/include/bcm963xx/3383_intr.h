...
#ifndef __3383_INTR_H
#define __3383_INTR_H
...
#define INTERRUPT_ID_UART0               (INTERNAL_ISR_TABLE_OFFSET + 2)
...
#define INTERRUPT_ID_USB_OHCI            (INTERNAL_ISR_TABLE_OFFSET + 23)
#define INTERRUPT_ID_USB_EHCI            (INTERNAL_ISR_TABLE_OFFSET + 24)
...
#define INTERRUPT_ID_DQM_IRQ             (INTERNAL_ISR_TABLE_OFFSET + 32 + 3)
#define INTERRUPT_ID_MBOX_IN_IRQ         (INTERNAL_ISR_TABLE_OFFSET + 32 + 4)
#define INTERRUPT_ID_MBOX_OUT_IRQ        (INTERNAL_ISR_TABLE_OFFSET + 32 + 5)

#if defined(CONFIG_BCM93383) && defined(CONFIG_BCM_LOT1)
#define INTERRUPT_ID_MEP_IRQ             (INTERNAL_ISR_TABLE_OFFSET + 32 + 12)
#define INTERRUPT_ID_MSP_IRQ             (INTERNAL_ISR_TABLE_OFFSET + 32 + 11)
#define INTERRUPT_ID_PMC_IRQ             (INTERNAL_ISR_TABLE_OFFSET + 32 + 13)
#define INTERRUPT_ID_MSP_SW_IRQ          (INTERNAL_ISR_TABLE_OFFSET + 32 + 13)
#else
#define INTERRUPT_ID_MSP_IRQ             (INTERNAL_ISR_TABLE_OFFSET + 32 + 32 + 3)
#endif

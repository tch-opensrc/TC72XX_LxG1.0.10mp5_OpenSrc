...
#if defined(CONFIG_BCM93329) || defined(CONFIG_BCM96362) || defined(CONFIG_BCM96328)
...
static int map_external_irq (int irq)
{
    ...
    case BP_EXT_INTR_3   :
        ...
        break ;
#if defined(CONFIG_BCM96368) || defined(CONFIG_BCM93329)
    case BP_EXT_INTR_4   :
...
#endif
#if (0) //defined(CONFIG_BCM93329) || defined(CONFIG_BCM96362) || defined(CONFIG_BCM96328)
                       ...
                       unsigned int command, unsigned long arg )
{
    ...
    case BOARD_IOCTL_GET_CHIP_ID:
        ...
        /* Force BCM681x variants to be be BCM3329) */
        if( (ctrlParms.result & 0xfff0) == 0x6810 )
            ctrlParms.result = 0x3329;

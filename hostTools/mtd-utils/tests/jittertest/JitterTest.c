 ...
 *
 *  Revision History:
 *  $Id: //depot/brcm/head/bcm963xx/userspace/gpl/apps/mtd-utils/tests/jittertest/JitterTest.c#1 $
 *  $Log: JitterTest.c,v $
...
static const char Version[] = "$Id: //depot/brcm/head/bcm963xx/userspace/gpl/apps/mtd-utils/tests/jittertest/JitterTest.c#1 $";

 ...
 *
  ...
  $Id: //depot/brcm/head/bcm963xx/userspace/gpl/apps/mtd-utils/tests/jittertest/plotJittervsFill.c#1 $
...
static char Version_string[] = "$Id: //depot/brcm/head/bcm963xx/userspace/gpl/apps/mtd-utils/tests/jittertest/plotJittervsFill.c#1 $";
